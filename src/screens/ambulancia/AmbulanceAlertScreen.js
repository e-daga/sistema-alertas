...
export default function AmbulanceAlertScreen({ navigation, route }) {
  ...
  const goToReport = async () => {
    ...
    navigation.navigate("AmbulanceReport", { alert });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.line}>Unidad asignada: {alert?.unidadAsignada || alert?.unidad?.codigo || "Ambulancia"}</Text>
...
const styles = StyleSheet.create({
  ...
  badge: { backgroundColor: "#EF4444", paddingHorizontal: 10, paddingVertical: 3, borderRadius: 999 },
